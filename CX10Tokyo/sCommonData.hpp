...
extern DELPHI_PACKAGE System::Uitypes::TColor __fastcall GetFontColor(Vcl::Controls::TControl* const Ctrl, const int DefSkinIndex, Sskinmanager::TsSkinManager* const SkinManager, const int State = 0x0)/* overload */;
...
extern DELPHI_PACKAGE HRGN __fastcall GetRgnFromSkin(int ASectionIndex, const System::Types::TSize &CtrlSize, Sskinmanager::TsSkinManager* SM = (Sskinmanager::TsSkinManager*)(0x0));
extern DELPHI_PACKAGE void __fastcall GetTransCorners(int ASectionIndex, Vcl::Graphics::TBitmap* aBmp, Sskinmanager::TsSkinManager* SM = (Sskinmanager::TsSkinManager*)(0x0));
