...
extern PACKAGE void __fastcall AddToAdapter(const Vcl::Controls::TWinControl* Frame);
...
extern PACKAGE Vcl::Controls::THintWindow* __fastcall acShowHintWnd(System::UnicodeString HintText, const System::Types::TPoint &Pos);
...
extern PACKAGE int __fastcall TrySendMessage(const Vcl::Controls::TControl* Control, const Winapi::Messages::TMessage &Message)/* overload */;
...
extern PACKAGE void __fastcall RepaintsControls(const Vcl::Controls::TWinControl* Owner, const bool BGChanged);
