...
// (DO NOT EDIT: machine generated header) 'acArcControls.pas' rev: 23.00 (Win32)
...
enum TacMotionType : unsigned char { mtNormal, mtAcceleration };
#pragma option pop

#pragma option push -b-
enum TacImageType : unsigned char { itLine, itMask1, itMask2, itCustomMask, itCustomImage };
#pragma option pop
...
private:
	...
	void __fastcall SetCustomImage(const Vcl::Graphics::TBitmap* Value);
	virtual void __fastcall SetInteger(const int Index, const int Value);
	HIDESBASE void __fastcall SetColor(const int Index, const System::Uitypes::TColor Value);
	virtual void __fastcall SetBoolean(const int Index, const bool Value);
...
#pragma option push -b-
enum TacKnobPosition : unsigned char { kpCircle, kpBevel };
#pragma option pop
...
#pragma option push -b-
enum TacTextContent : unsigned char { tcValue, tcPercent, tcAngle, tcCustom };
#pragma option pop
