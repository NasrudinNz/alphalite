...
extern PACKAGE void __fastcall DrawColorArrow(const Vcl::Graphics::TCanvas* Canvas, const System::Uitypes::TColor Color, const System::Types::TRect &R, const Sconst::TacSide Direction)/* overload */;
extern PACKAGE void __fastcall DrawColorArrow(const Vcl::Graphics::TBitmap* aBmp, const System::Uitypes::TColor Color, const System::Types::TRect &R, const Sconst::TacSide Direction)/* overload */;
extern PACKAGE void __fastcall DrawArrow(const Vcl::Graphics::TBitmap* aBmp, const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const System::Types::TRect &R, const Sconst::TacSide Direction, int LineWidth, int AngleShift, int ArrowSize, Acnttypes::TacArrowsStyle Style)/* overload */;
extern PACKAGE void __fastcall DrawArrow(HDC DC, const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const System::Types::TRect &R, const Sconst::TacSide Direction, int LineWidth, int AngleShift, int ArrowSize, Acnttypes::TacArrowsStyle Style)/* overload */;
...
extern PACKAGE void __fastcall acDrawCheck(const System::Types::TRect &R, const Vcl::Stdctrls::TCheckBoxState AState, const bool AEnabled, const Vcl::Graphics::TBitmap* Bmp, const Sconst::TCacheInfo &CI, const System::TObject* SkinManager, const bool SmallGlyphs = true);
...
extern PACKAGE HICON __fastcall MakeCompIcon(Vcl::Graphics::TBitmap* Img, System::Uitypes::TColor BGColor = (System::Uitypes::TColor)(0x1fffffff));
...
extern PACKAGE void __fastcall PaintItemBGFast(int SkinIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R, const System::Types::TPoint &pP, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern PACKAGE void __fastcall PaintItemFast(int SkinIndex, int MaskIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R, const System::Types::TPoint &pP, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R, const System::Types::TPoint &pP, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0), int BGIndex = 0xffffffff, int BGHotIndex = 0xffffffff)/* overload */;
extern PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R, const System::Types::TPoint &pP, HDC DC, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
...
extern PACKAGE int __fastcall PaintSection(const Vcl::Graphics::TBitmap* Bmp, System::UnicodeString Section, const System::UnicodeString SecondSection, const int State, const System::TObject* Manager, const System::Types::TPoint &ParentOffset, const System::Uitypes::TColor BGColor, HDC ParentDC = (HDC)(0x0))/* overload */;
extern PACKAGE int __fastcall PaintSection(const Vcl::Graphics::TBitmap* Bmp, int SectionIndex, const int SecondIndex, const int State, const System::TObject* Manager, const System::Types::TPoint &ParentOffset, const System::Uitypes::TColor BGColor, HDC ParentDC = (HDC)(0x0))/* overload */;
...
extern PACKAGE void __fastcall acWriteTextEx(const Vcl::Graphics::TCanvas* Canvas, const System::WideChar * Text, const bool Enabled, System::Types::TRect &aRect, const unsigned Flags, const Scommondata::TsCommonData* SkinData, const bool Hot, const System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
...
extern PACKAGE void __fastcall WriteTextEx(const Vcl::Graphics::TCanvas* Canvas, System::WideChar * Text, bool Enabled, System::Types::TRect &aRect, unsigned Flags, Scommondata::TsCommonData* SkinData, bool Hot)/* overload */;
...
extern PACKAGE void __fastcall BlendTransRectangle(Vcl::Graphics::TBitmap* Dst, int X, int Y, Vcl::Graphics::TBitmap* Src, const System::Types::TRect &aRect, double Blend, System::Uitypes::TColor TransColor = (System::Uitypes::TColor)(0xff00ff))/* overload */;
...
extern PACKAGE void __fastcall BlendTransBitmap(Vcl::Graphics::TBitmap* Bmp, double Blend, const Sconst::TsColor Color)/* overload */;
...
extern PACKAGE void __fastcall BlendBmpRectByMask(Vcl::Graphics::TBitmap* SrcBmp, Vcl::Graphics::TBitmap* MskBmp, const System::Types::TPoint &TopLeft, const Sconst::TsColor BlendColor);
...
extern PACKAGE void __fastcall PaintBmpRect32(const Vcl::Graphics::TBitmap* DstBmp, const Vcl::Graphics::TBitmap* SrcBmp, const System::Types::TRect &SrcRect, const System::Types::TPoint &DstPoint);
...
extern PACKAGE void __fastcall CopyTransRectA(Vcl::Graphics::TBitmap* DstBmp, Vcl::Graphics::TBitmap* SrcBmp, int X, int Y, const System::Types::TRect &SrcRect, System::Uitypes::TColor TransColor, const Sconst::TCacheInfo &CI);
...
extern PACKAGE System::Uitypes::TColor __fastcall MixColors(const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const double PercentOfColor1);
...
extern PACKAGE System::Types::TSize __fastcall GetStringSize(HGDIOBJ hFont, const System::UnicodeString Text, unsigned Flags = (unsigned)(0x0), bool WrapText = false, int MaxWidth = 0x7fffffff);
...
extern PACKAGE void __fastcall Stretch(const Vcl::Graphics::TBitmap* Src, const Vcl::Graphics::TBitmap* Dst, const int Width, const int Height, const TFilterType Filter, const int Param = 0x0);
