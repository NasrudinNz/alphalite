...
extern PACKAGE void __fastcall FillTransPixels32(const Vcl::Graphics::TBitmap* DstBmp, const Vcl::Graphics::TBitmap* SrcBmp, const System::Types::TRect &DstRect, const System::Types::TPoint &SrcPoint, int MaskIndex = 0xffffffff, System::TObject* SkinManager = (System::TObject*)(0x0), unsigned MaskPos = (unsigned)(0xd));
...
extern PACKAGE void __fastcall WriteText32(const Vcl::Graphics::TBitmap* Bmp, System::WideChar * Text, bool Enabled, System::Types::TRect &aRect, unsigned Flags, int SkinIndex, bool Hot, System::TObject* SkinManager = (System::TObject*)(0x0), bool IsAnsi = false);
...
extern PACKAGE void __fastcall BlendGlyphByMask(const System::Types::TRect &R1, const System::Types::TRect &R2, Vcl::Graphics::TBitmap* Bmp1, Vcl::Graphics::TBitmap* Bmp2, int AddedTransparency, const Smaskdata::TsMaskData &MaskData);
...
extern PACKAGE void __fastcall PaintItem32(int SkinIndex, bool Filling, int State, const System::Types::TRect &R, const System::Types::TPoint &pP, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern PACKAGE void __fastcall PaintItemBG32(int SkinIndex, int State, const System::Types::TRect &R, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager, System::Uitypes::TColor CustomColor = (System::Uitypes::TColor)(0xff00ff));
