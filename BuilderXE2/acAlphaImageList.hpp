...
extern PACKAGE System::Types::TSize __fastcall DrawAlphaImgList(const Vcl::Imglist::TCustomImageList* ImgList, const Vcl::Graphics::TBitmap* DestBmp, const int Left, const int Top, const int ImageIndex, const int Blend, const System::Uitypes::TColor GrayedColor, int State, const int NumGlyphs, const bool Reflected);
extern PACKAGE void __fastcall DrawAlphaImgListDC(const Vcl::Imglist::TCustomImageList* ImgList, const HDC DC, const int Left, const int Top, const int ImageIndex, const int Blend, const System::Uitypes::TColor GrayedColor, const int State, const int NumGlyphs, const bool Reflected);
