...
__published:
	...
	__property Vcl::Graphics::TFont* Font = {read=GetFont, write=SetFont, stored=DoStoreFont};
...
extern PACKAGE System::Uitypes::TColor __fastcall GetFontColor(const Vcl::Controls::TControl* Ctrl, const int DefSkinIndex, const Sskinmanager::TsSkinManager* SkinManager, const int State = 0x0)/* overload */;
...
extern PACKAGE void __fastcall UpdateBmpColors(Vcl::Graphics::TBitmap* Bmp, TsCommonData* SkinData, bool CheckCorners, int State);
...
extern PACKAGE HRGN __fastcall GetRgnFromSkin(int ASectionIndex, const System::Types::TSize &CtrlSize, Sskinmanager::TsSkinManager* SM = (Sskinmanager::TsSkinManager*)(0x0));
extern PACKAGE void __fastcall GetTransCorners(int ASectionIndex, Vcl::Graphics::TBitmap* aBmp, Sskinmanager::TsSkinManager* SM = (Sskinmanager::TsSkinManager*)(0x0));
