...
extern PACKAGE System::Types::TRect __fastcall RotateRect(const System::Types::TRect &R);
...
extern PACKAGE System::Types::TSize __fastcall MkSize(Vcl::Graphics::TBitmap* Bmp)/* overload */;
