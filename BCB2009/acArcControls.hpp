...
// (DO NOT EDIT: machine generated header) 'Acarccontrols.pas' rev: 20.00
...
protected:
	...
	System::UnicodeString __fastcall ShownText();
...
public:
	...
	DYNAMIC bool __fastcall CanFocus(void);
	void __fastcall DoProgress(System::UnicodeString ANewText = L"", int AStep = 0x0);
	virtual void __fastcall Loaded(void);
...
protected:
	...
	virtual System::UnicodeString __fastcall HandleText();
	virtual void __fastcall PrepareCache(void);
