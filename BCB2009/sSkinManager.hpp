...
typedef StaticArray<Graphics::TColor, 43> TacPaletteArray;
...
private:
	typedef DynamicArray<Controls::TControl*> _TacSkinListController__1;
	
	typedef DynamicArray<TacSkinListData> _TacSkinListController__2;
...
typedef StaticArray<char, 16> TsCharArray;
...
extern PACKAGE bool __fastcall GetPreviewStream(Classes::TMemoryStream* aStream, System::UnicodeString SkinFileName)/* overload */;
extern PACKAGE bool __fastcall GetPreviewStream(Classes::TMemoryStream* aStream, Classes::TMemoryStream* SrcStream)/* overload */;
extern PACKAGE bool __fastcall GetPreviewImage(Graphics::TBitmap* aBitmap, System::UnicodeString SkinFileName);
