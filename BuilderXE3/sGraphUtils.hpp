...
extern DELPHI_PACKAGE void __fastcall DrawColorArrow(Vcl::Graphics::TCanvas* const Canvas, const System::Uitypes::TColor Color, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawColorArrow(Vcl::Graphics::TBitmap* const aBmp, const System::Uitypes::TColor Color, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawArrow(Vcl::Graphics::TBitmap* const aBmp, const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction, int LineWidth, int AngleShift, int ArrowSize, Acnttypes::TacArrowsStyle Style)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawArrow(HDC DC, const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction, int LineWidth, int AngleShift, int ArrowSize, Acnttypes::TacArrowsStyle Style)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall PaintItemBG(int SkinIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0), int TextureIndex = 0xffffffff, int HotTextureIndex = 0xffffffff, System::Uitypes::TColor CustomColor = (System::Uitypes::TColor)(0xff00ff))/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemBGFast(int SkinIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemFast(int SkinIndex, int MaskIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0), int BGIndex = 0xffffffff, int BGHotIndex = 0xffffffff)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, HDC DC, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
...
extern DELPHI_PACKAGE void __fastcall BlendTransRectangle(Vcl::Graphics::TBitmap* Dst, int X, int Y, Vcl::Graphics::TBitmap* Src, const System::Types::TRect &aRect _ANNOT_ATTR_NC, double Blend, System::Uitypes::TColor TransColor = (System::Uitypes::TColor)(0xff00ff))/* overload */;
...
extern DELPHI_PACKAGE void __fastcall BlendBmpRectByMask(Vcl::Graphics::TBitmap* SrcBmp, Vcl::Graphics::TBitmap* MskBmp, const System::Types::TPoint &TopLeft _ANNOT_ATTR_NC, const Sconst::TsColor BlendColor);
...
extern DELPHI_PACKAGE void __fastcall PaintBmpRect32(Vcl::Graphics::TBitmap* const DstBmp, Vcl::Graphics::TBitmap* const SrcBmp, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC, const System::Types::TPoint &DstPoint _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE void __fastcall CopyTransRectA(Vcl::Graphics::TBitmap* DstBmp, Vcl::Graphics::TBitmap* SrcBmp, int X, int Y, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC, System::Uitypes::TColor TransColor, const Sconst::TCacheInfo &CI _ANNOT_ATTR_NC);
