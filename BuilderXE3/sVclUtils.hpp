...
extern DELPHI_PACKAGE Vcl::Controls::THintWindow* __fastcall acShowHintWnd(System::UnicodeString HintText, const System::Types::TPoint &Pos _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE void __fastcall PaintControls(HDC DC, Vcl::Controls::TWinControl* OwnerControl, bool ChangeCache, const System::Types::TPoint &Offset _ANNOT_ATTR_NC, NativeUInt AHandle = (NativeUInt)(0x0), bool CheckVisible = true);
...
extern DELPHI_PACKAGE NativeInt __fastcall TrySendMessage(Vcl::Controls::TControl* const Control, const Winapi::Messages::TMessage &Message _ANNOT_ATTR_NC)/* overload */;
