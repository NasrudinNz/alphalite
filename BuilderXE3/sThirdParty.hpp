...
extern DELPHI_PACKAGE int __fastcall GetImageWidth(Vcl::Imglist::TCustomImageList* ImgList);
extern DELPHI_PACKAGE int __fastcall GetImageHeight(Vcl::Imglist::TCustomImageList* ImgList);
