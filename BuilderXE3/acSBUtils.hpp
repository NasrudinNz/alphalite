...
extern DELPHI_PACKAGE void __fastcall ac_DrawScrollBtn(const System::Types::TRect &bRect _ANNOT_ATTR_NC, int State, Vcl::Graphics::TBitmap* Bmp, Scommondata::TsCommonData* cd, Sconst::TacSide Side);
extern DELPHI_PACKAGE void __fastcall ac_DrawSlider(const System::Types::TRect &bRect _ANNOT_ATTR_NC, int State, Vcl::Graphics::TBitmap* Bmp, Sskinmanager::TsSkinManager* sm, bool Vert);
...
extern DELPHI_PACKAGE System::Types::TRect __fastcall BtnDrawRect(const System::Types::TRect &R _ANNOT_ATTR_NC, Scommondata::TsCommonData* cd, Sconst::TacSide Side);
}	/* namespace Acsbutils */
