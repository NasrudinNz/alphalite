...
extern DELPHI_PACKAGE void __fastcall acgpGradientRectangle(HDC DC, float X, float Y, float Width, float Height, System::Types::TPoint *Points, Sconst::TsColor *Colors, Sconst::TsColor CenterColor);
}	/* namespace Acgputils */
