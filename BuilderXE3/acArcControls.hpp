...
// (DO NOT EDIT: machine generated header) 'acArcControls.pas' rev: 24.00 (Windows)
...
protected:
	...
	void __fastcall PaintGlyph(const System::Types::TRect &R _ANNOT_ATTR_NC, System::Uitypes::TColor GrayColor = (System::Uitypes::TColor)(0x1fffffff));
...
protected:
	...
	void __fastcall PaintHandle(const System::Types::TRect &ARect _ANNOT_ATTR_NC);
	virtual int __fastcall ValueToAngle(int AValue) = 0 ;
	void __fastcall PaintBG(void);
	void __fastcall ChangePosition(const System::Types::TPoint &pSrc _ANNOT_ATTR_NC, const System::Types::TPoint &pDst _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE void __fastcall DrawRoundButton(HDC DC, int Left, int Top, int Diameter, const Acnttypes::TacButtonPaintData &dpData _ANNOT_ATTR_NC);
}	/* namespace Acarccontrols */
