...
protected:
	...
	void __fastcall PaintDivider(Vcl::Graphics::TCanvas* aCanvas, const System::Types::TRect &aRect _ANNOT_ATTR_NC, Vcl::Menus::TMenuItem* Item, Vcl::Graphics::TBitmap* MenuBmp, const TacMenuInfo &mi);
	void __fastcall PaintCaption(Vcl::Graphics::TCanvas* aCanvas, const System::Types::TRect &aRect _ANNOT_ATTR_NC, Vcl::Menus::TMenuItem* Item, Vcl::Graphics::TBitmap* BG, const TacMenuInfo &mi);
