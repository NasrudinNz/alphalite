...
enum DECLSPEC_DENUM TsCaptionLayout : unsigned char { sclLeft, sclTopLeft, sclTopCenter, sclTopRight, sclLeftTop, sclBottomLeft, sclBottomCenter, sclBottomRight, sclRight, sclRightTop, sclLeftLeft };
...
extern DELPHI_PACKAGE int acAddedTabSpacing;
...
extern DELPHI_PACKAGE int ac_CXSIZEFRAME;
extern DELPHI_PACKAGE int ac_CXFIXEDFRAME;
extern DELPHI_PACKAGE int ac_CYCAPTION;
extern DELPHI_PACKAGE int ac_CYSMCAPTION;
extern DELPHI_PACKAGE int ac_ArrowWidth;
extern DELPHI_PACKAGE int ac_ArrowHeight;
...
extern DELPHI_PACKAGE NativeUInt Lib;
