...
extern DELPHI_PACKAGE int __cdecl asSkinDecode(const TsCharArray &PackedData, __int64 *Keys, const int Keys_Size, const int Length, const int FormSum, /* out */ int &FilesCount, /* out */ int &Offset);
}	/* namespace Sskinmanager */
