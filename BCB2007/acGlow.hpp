...
extern PACKAGE int __fastcall ShowGlow(const Types::TRect &RealRect, int * MaskIndexes, const int MaskIndexes_Size, const int Margin, const int Alpha, HWND WndHandle, Scommondata::TsCommonData* SkinData = (Scommondata::TsCommonData*)(0x0))/* overload */;
