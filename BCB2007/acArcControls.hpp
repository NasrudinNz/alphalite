...
// (DO NOT EDIT: machine generated header) 'Acarccontrols.pas' rev: 11.00
...
class PASCALIMPLEMENTATION TsArcControl : public Controls::TWinControl 
{
...
protected:
	...
	void __fastcall PaintGlyph(const Types::TRect &R, Graphics::TColor GrayColor = (Graphics::TColor)(0x1fffffff));
	int __fastcall Diameter(void);
	Graphics::TColor __fastcall FontColor(void);
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation);
	__property Graphics::TCanvas* Canvas = {read=FCanvas};
	
public:
	__fastcall virtual TsArcControl(Classes::TComponent* AOwner);
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TsArcControl(HWND ParentWindow) : Controls::TWinControl(ParentWindow) { }
	#pragma option pop
...
#pragma pack(push,4)
struct TacGaugePaintData
{
	
public:
	Graphics::TColor ABaseColor;
	Graphics::TColor AFontColor;
	Graphics::TColor AProgressColor;
	int ALineWidth;
	AnsiString AText;
} ;
#pragma pack(pop)
...
protected:
	...
	AnsiString __fastcall ShownText();
	
public:
	__fastcall virtual TsArcGauge(Classes::TComponent* AOwner);
...
__published:
	...
	__property Graphics::TColor BaseColor = {read=FBaseColor, write=SetColor, index=10, default=9868950};
	__property Graphics::TColor ProgressColor = {read=FProgressColor, write=SetColor, index=11, default=16748834};
...
#pragma pack(push,4)
struct TacPreloaderPaintData
{
	
public:
	Graphics::TColor ABaseColor;
	Graphics::TColor ALineColor;
	Graphics::TColor AFontColor;
	int ALineWidth;
	AnsiString AText;
} ;
...
enum TacMotionType { mtNormal, mtAcceleration };
#pragma option pop

#pragma option push -b-
enum TacImageType { itLine, itMask1, itMask2, itCustomMask, itCustomImage };
#pragma option pop
...
private:
	...
	bool FStretched;
	bool FAnimated;
	Graphics::TBitmap* FCustomImage;
	Graphics::TBitmap* StretchBmp;
	...
	void __fastcall SetCustomImage(const Graphics::TBitmap* Value);
	virtual void __fastcall SetInteger(const int Index, const int Value);
	HIDESBASE void __fastcall SetColor(const int Index, const Graphics::TColor Value);
	virtual void __fastcall SetBoolean(const int Index, const bool Value);
...
public:
	__fastcall virtual TsArcPreloader(Classes::TComponent* AOwner);
	__fastcall virtual ~TsArcPreloader(void);
	DYNAMIC bool __fastcall CanFocus(void);
	void __fastcall DoProgress(AnsiString ANewText = "", int AStep = 0x0);
	virtual void __fastcall Loaded(void);
...
__published:
	...
	__property Graphics::TColor BaseColor = {read=FBaseColor, write=SetColor, index=10, default=9868950};
	__property Graphics::TColor LineColor = {read=FLineColor, write=SetColor, index=11, default=16748834};
	...
	__property Graphics::TBitmap* CustomImage = {read=FCustomImage, write=SetCustomImage};
	__property BaseAngle  = {index=1, default=-90};
	__property GlyphIndex  = {index=0, default=-1};
	__property Text ;
...
public:
	...
	__fastcall virtual TacPreAnimTimer(Classes::TComponent* AOwner);
public:
	#pragma option push -w-inl
	/* TacThreadedTimer.CreateOwned */ inline __fastcall virtual TacPreAnimTimer(Classes::TComponent* AOwner, bool ChangeEvent) : Acthdtimer::TacThreadedTimer(AOwner, ChangeEvent) { }
	#pragma option pop
	#pragma option push -w-inl
...
#pragma option push -b-
enum TacKnobPosition { kpCircle, kpBevel };
#pragma option pop
...
protected:
	double RealPosition;
	#pragma pack(push,1)
	Types::TPoint CurrentMouse;
	#pragma pack(pop)
	tagSIZE __fastcall GlyphSize();
	tagSIZE __fastcall ContentSize();
	virtual AnsiString __fastcall HandleText(void) = 0 ;
	void __fastcall DoInvalidate(System::TObject* Sender);
	void __fastcall PaintHandle(const Types::TRect &ARect);
	virtual int __fastcall ValueToAngle(int AValue) = 0 ;
	void __fastcall PaintBG(void);
	void __fastcall ChangePosition(const Types::TPoint &pSrc, const Types::TPoint &pDst);
	virtual bool __fastcall CanChange(double &ADelta);
	virtual Types::TRect __fastcall HandleRect(void) = 0 ;
	
public:
	int __fastcall AngleToValue(int AAngle);
	virtual void __fastcall WndProc(Messages::TMessage &Message);
	__fastcall virtual TsArcKnobControl(Classes::TComponent* AOwner);
...
#pragma option push -b-
enum TacTextContent { tcValue, tcPercent, tcAngle, tcCustom };
#pragma option pop
...
protected:
	...
	virtual AnsiString __fastcall HandleText();
	virtual void __fastcall PrepareCache(void);
	virtual Types::TRect __fastcall HandleRect();
	
public:
	__fastcall virtual TsArcHandle(Classes::TComponent* AOwner);
...
#pragma pack(push,4)
struct TacDialPaintData
{
	
public:
	Graphics::TColor APenColor;
	Graphics::TColor ABaseColor;
	Graphics::TColor AFontColor;
	int APenWidth;
} ;
...
public:
	__fastcall virtual TsArcDial(Classes::TComponent* AOwner);
...
public:
	__fastcall virtual TacCustomRoundBtn(Classes::TComponent* AOwner);
...
public:
	#pragma option push -w-inl
	/* TacCustomRoundBtn.Create */ inline __fastcall virtual TsRoundBtn(Classes::TComponent* AOwner) : TacCustomRoundBtn(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
//-- var, const, procedure ---------------------------------------------------
static const Shortint DefaultSize = 0x52;
static const Byte DefaultBaseBlend = 0xde;
extern PACKAGE void __fastcall InitBtnPaintData(Sskinmanager::TsSkinManager* SM, Scommondata::TsCommonData* SkinData, int State, Acnttypes::TacPaintButtonOptions* PaintOptions, Acnttypes::TacButtonPaintData &dpData);
extern PACKAGE void __fastcall DrawRoundButton(HDC DC, int Left, int Top, int Diameter, const Acnttypes::TacButtonPaintData &dpData);
