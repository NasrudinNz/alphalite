...
extern PACKAGE Graphics::TColor __fastcall GetFontColor(const Controls::TControl* Ctrl, const int DefSkinIndex, const Sskinmanager::TsSkinManager* SkinManager, const int State = 0x0)/* overload */;
...
extern PACKAGE HRGN __fastcall GetRgnFromSkin(int ASectionIndex, const tagSIZE &CtrlSize, Sskinmanager::TsSkinManager* SM = (Sskinmanager::TsSkinManager*)(0x0));
extern PACKAGE void __fastcall GetTransCorners(int ASectionIndex, Graphics::TBitmap* aBmp, Sskinmanager::TsSkinManager* SM = (Sskinmanager::TsSkinManager*)(0x0));
