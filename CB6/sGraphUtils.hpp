...
extern PACKAGE int __fastcall PaintSection(const Graphics::TBitmap* Bmp, AnsiString Section, const AnsiString SecondSection, const int State, const System::TObject* Manager, const Types::TPoint &ParentOffset, const Graphics::TColor BGColor, HDC ParentDC = (HDC)(0x0))/* overload */;
...
extern PACKAGE void __fastcall acWriteTextEx(const Graphics::TCanvas* Canvas, const char * Text, const bool Enabled, Types::TRect &aRect, const unsigned Flags, const Scommondata::TsCommonData* SkinData, const bool Hot, const System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
...
extern PACKAGE tagSIZE __fastcall GetStringSize(HGDIOBJ hFont, const AnsiString Text, unsigned Flags = (unsigned)(0x0), bool WrapText = false, int MaxWidth = 0x7fffffff);
